...
<aside id="sidebar" class="sidebar" style="background: var(--color-dark-light); padding: 2rem; border-radius: 12px; margin-top: 2rem;">
    ...
    <div class="widget">
        <h3 class="widget-title" style="color: var(--color-primary); font-size: 1.2rem; margin-bottom: 1rem; font-weight: 700;">Temporadas Populares</h3>
        <ul style="list-style: none; display: flex; flex-direction: column; gap: 0.5rem;">
            ...
            foreach ($categories as $category) {
                ...
                echo '<span style="color: var(--color-primary);">' . $category->count . ' capítulos</span>';
                echo '</a>';
                echo '</li>';
            }
            ?>
    ...
    <div class="widget" style="margin-top: 2rem;">
        <h3 class="widget-title" style="color: var(--color-primary); font-size: 1.2rem; margin-bottom: 1rem; font-weight: 700;">Capítulos Recientes</h3>
