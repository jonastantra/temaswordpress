<?php
/**
 * Single Post Template - Página Individual de Episodio Los Simpsons
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('episode-single'); ?>>
            ...
            <div class="video-player-section">
                <div class="video-player-container">
                    ...
                    // Optimizar iframes
                    $player1 = simpsons_optimize_iframe($player1);
                    $player2 = simpsons_optimize_iframe($player2);
                    $player3 = simpsons_optimize_iframe($player3);
                    ?>
                ...
                <div class="nav-buttons">
                    ...
                    <?php if ($next_post) : ?>
                        <a href="<?php echo get_permalink($next_post); ?>" class="nav-button next-episode">
                            <div class="nav-info">
                                <span class="nav-label">Siguiente Capítulo</span>
            ...
            <!-- Episodios Relacionados (Misma Temporada) -->
            <section class="related-episodes">
                <h2>Más Capítulos de Esta Temporada</h2>
                    ...
                    if ($categories) {
                        ...
                        if ($related_query->have_posts()) :
                            ...
                            <p style="grid-column: 1 / -1; text-align: center; color: var(--color-text-muted);">
                                No hay capítulos relacionados disponibles.
                            </p>
                            <?php
                        endif;
                    }
